...
package cn.join.android.net.http;
...
public class AsyncHttpClient {
    ...
    public String syncDelete(String url, RequestParams params, Header[] headers) throws ClientProtocolException, IOException {
        ...
        return parseResponse(syncExec(httpDelete));
    }

    public String syncDelete(String url, RequestParams params) throws ClientProtocolException, IOException {
        HttpDeleteWithBody httpDelete = new HttpDeleteWithBody(url);
        if (params != null) {
            HttpEntity httpEntity = paramsToEntity(params);
            httpDelete.setEntity(httpEntity);
    ...
    public String syncDelete(String url, Header[] headers, HttpEntity entity) throws ClientProtocolException, IOException {
        HttpDeleteWithBody httpDelete = new HttpDeleteWithBody(url);
        if (headers != null) {
            httpDelete.setHeaders(headers);
        }
    ...
    public String syncDelete(String url, HttpEntity entity) throws ClientProtocolException, IOException {
        HttpDeleteWithBody httpDelete = new HttpDeleteWithBody(url);
        if (entity != null) {
            httpDelete.setEntity(entity);
        }
