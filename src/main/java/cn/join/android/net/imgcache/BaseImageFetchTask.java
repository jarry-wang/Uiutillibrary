...
import cn.join.android.net.imgcache.ImageWorker.AsyncDrawable;
import cn.join.android.util.NinePatchBitmapFactory;
...
public class BaseImageFetchTask implements ImageFetchTask {
	...
	public void setDrawable(View view, Drawable drawable) {
		...
		if (enableTransition && !(drawable instanceof AsyncDrawable)
		...
		Bitmap btmap = ((BitmapDrawable) drawable).getBitmap();
