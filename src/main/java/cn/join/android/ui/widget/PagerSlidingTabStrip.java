...
//		tabTextSize = a.getDimensionPixelSize(0, tabTextSize);
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextColor, indicatorColor);
        tabSelectTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextColorSelect, indicatorColor);
