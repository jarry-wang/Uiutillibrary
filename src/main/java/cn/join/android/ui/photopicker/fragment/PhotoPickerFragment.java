package cn.join.android.ui.photopicker.fragment;
...
import cn.join.android.ui.photopicker.adapter.PhotoGridAdapter;
import cn.join.android.ui.photopicker.adapter.PopupDirectoryListAdapter;
import cn.join.android.ui.photopicker.entity.Photo;
import cn.join.android.ui.photopicker.entity.PhotoDirectory;
import cn.join.android.ui.photopicker.event.OnPhotoClickListener;
import cn.join.android.ui.photopicker.utils.ImageCaptureManager;
import cn.join.android.ui.photopicker.utils.MediaStoreHelper;
...
import static cn.join.android.ui.photopicker.utils.MediaStoreHelper.INDEX_ALL_PHOTOS;
...
public class PhotoPickerFragment extends Fragment {
    ...
    private static int maxImgCount = DEFAULT_MAX_COUNT;
        ...
        photoGridAdapter.setOnPhotoClickListener(new OnPhotoClickListener() {
            ...
            public void onClick(View v, int position, boolean showCamera) {
                ...
                PhotoPreview.builder()
                        .setPhotos(photos)
                        .setSelectedPhotos(photoGridAdapter.getSelectedPhotoPaths())
                        .setCurrentItem(index)
                        .setAction(MultiPickResultView.ACTION_SELECT)
                        .setMaxCount(maxImgCount)
                        .start(getActivity(), PhotoPreview.REQUEST_CODE);
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (directories.size() > 0) {
                ...
                directory.getPhotos().add(INDEX_ALL_PHOTOS, new Photo(path));
