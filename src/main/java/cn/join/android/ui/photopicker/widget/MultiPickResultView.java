...
public class MultiPickResultView extends FrameLayout {
    ...
    @IntDef({ACTION_SELECT, ACTION_ONLY_SHOW, ACTION_PREVIEW})
    ...
    public static final int ACTION_PREVIEW = 3;//该组件用于图片删除(预览模式, 在展示的组件中点击过来,  显示删除按钮)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (action == ACTION_SELECT || action == ACTION_PREVIEW) {
