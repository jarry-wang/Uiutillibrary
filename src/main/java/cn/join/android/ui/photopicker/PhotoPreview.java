...
public class PhotoPreview {
    ...
    public static class PhotoPreviewBuilder {
         ...
         * @return
         */
        public PhotoPreviewBuilder setSelectedPhotos(ArrayList<String> photoPaths) {
            mPreviewOptionsBundle.putStringArrayList(EXTRA_SELECTED_PHOTOS, photoPaths);
            return this;
        }
        ...
        public PhotoPreviewBuilder setMaxCount(int maxCount) {
            mPreviewOptionsBundle.putInt(EXTRA_MAX_COUNT, maxCount);
            return this;
        }
    }
}
